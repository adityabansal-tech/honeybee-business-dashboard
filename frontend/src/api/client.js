...
// --- MOCK DATA FALLBACKS FOR THE LIVE SITE ---
const MOCK_SUMMARY = {
  total_listings: 550,
  total_cities: 5,
  total_categories: 4,
...
const MOCK_LISTINGS = {
  data: [
    ...
    { id: 3, name: "Apex Fitness Gym", category: "Healthcare", city: "Delhi", rating: 4.2, source: "Google Maps" },
...
export const getByCity = () => 
  client.get("/api/dashboard/by-city")
    .then(r => r.data)
    .catch(() => MOCK_BY_CITY);

export const getByCategory = () => 
  client.get("/api/dashboard/by-category")
    .then(r => r.data)
    .catch(() => MOCK_BY_CATEGORY);

export const getBySource = () => 
  client.get("/api/dashboard/by-source")
    .then(r => r.data)
    .catch(() => MOCK_BY_SOURCE);
